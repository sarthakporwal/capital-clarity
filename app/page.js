...
const LandingPage = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-black transition-colors">
      ...
      {/* Stats Section */}
      <section className="py-20 bg-blue-50 dark:bg-zinc-900 transition-colors">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuresData.map((feature, index) => (
              <Card className="p-6 dark:bg-zinc-900 dark:border-zinc-800 transition-colors" key={index}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonialsData.map((testimonial, index) => (
              <Card key={index} className="p-6 dark:bg-zinc-900 dark:border-zinc-800 transition-colors">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-blue-600 dark:bg-blue-900 transition-colors">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/dashboard">
            <Button
              size="lg"
              className="bg-white text-blue-600 hover:bg-blue-50 dark:bg-zinc-900 dark:text-white dark:hover:bg-zinc-800 animate-bounce transition-colors"
            >
              Start Free Trial
            </Button>
          </Link>
